...
async def milestones():
    ...
    all_milestones = [
        ...
        {"key": "affection_50", "type": "affection", "threshold": 50, "name": "好感", "desc": "好感度首次突破50，夕语开始对你产生亲近感", "unlocked": affection >= 50},
        {"key": "affection_70", "type": "affection", "threshold": 70, "name": "喜欢", "desc": "好感度首次突破70，夕语已经很喜欢和你聊天了", "unlocked": affection >= 70},
        {"key": "affection_85", "type": "affection", "threshold": 85, "name": "依赖", "desc": "好感度首次突破85，夕语开始依赖你的存在", "unlocked": affection >= 85},
        {"key": "trust_30", "type": "trust", "threshold": 30, "name": "信任萌芽", "desc": "信任度首次突破30", "unlocked": trust >= 30},
        {"key": "trust_50", "type": "trust", "threshold": 50, "name": "信赖", "desc": "信任度首次突破50，夕语开始向你敞开心扉", "unlocked": trust >= 50},
        {"key": "trust_70", "type": "trust", "threshold": 70, "name": "深信", "desc": "信任度首次突破70，夕语几乎完全信任你", "unlocked": trust >= 70},
        {"key": "trust_85", "type": "trust", "threshold": 85, "name": "托付", "desc": "信任度首次突破85，夕语愿意把一切告诉你", "unlocked": trust >= 85},
    ]
