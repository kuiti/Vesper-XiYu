...
_LOG_PATH = "/var/log/sakura.log" if os.path.isdir("/var/log") else os.path.join("data", "sakura_auth.log")
...
def _get_token() -> str:
    """从环境变量读取 API Token"""
    return os.environ.get("SAKURA_API_TOKEN", "")


def _is_cloud_mode() -> bool:
    """是否为云端模式（设置了 SAKURA_API_TOKEN）"""
