...
.goal-item { display: flex; justify-content: space-between; align-items: center; padding: 8px 10px; background: var(--surface-sidebar); border-radius: 6px; margin-bottom: 6px; }
...
.goal-text { color: var(--text-primary); font-size: 14px; }
...
.goal-stats { text-align: center; color: var(--accent-primary); font-size: 13px; margin-top: 8px; }
</style>
